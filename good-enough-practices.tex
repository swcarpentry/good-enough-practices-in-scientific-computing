...
\item
  ...
  variable for time point.  Figure~\ref{fig:tidy} presents an example
...
\item
  ...
  ``runall''.  The short example in Figure~\ref{fig:script} is typical
...
The diagram in Figure~\ref{fig:project} provides a concrete example of
...
great joys of version control. Unfortunately, Microsoft\textsuperscript{\textregistered}
...
editor file format (e.g., Microsoft\textsuperscript{\textregistered}
...
LibreOffice and Microsoft\textregistered Word with either email or
