...
has been written on this topic (refs!), and this section focuses on
practices that best balance ease of use with benefit for you and
collaborators.
...
% TKT: We've already made the decision in another section to have two
% sets of recommendations. I don't think we need this description
% here.
%
% It's a different style than the rest of the paper, and even though
% we're describing Google docs as 'good enough' it comes across as
% being 'less than because you're not good enough to use these tools',
% which is not what we're trying to say.
%
% GVW: I think this is likely to trigger a lot of disagreement, so
% it's worth spelling out our reasoning for this particular pair of
% recommendations.  In particular, I think the two quotes are
% necessary to show ``true believers'' what the world looks like
% to rank-and-file researchers.
...
\newblock Ten simple rules for digital data storage; 2015.

\bibitem{ffIllinois}
U.~of~Illinois~Library
\newblock File Formats and Organization;.
\newblock Available from:
...
\bibitem{shade2015}
Shade A, Teal T TK.
\newblock Computing Workflows for Biologists: A Roadmap.
\newblock PLoS Biology, November 2015.
\newblock doi:10.1371/journal.pbio.1002303.
