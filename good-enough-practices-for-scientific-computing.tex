...
to people who consider themselves computing neophytes and can be
applied by both individuals and groups.

Most importantly, we believe that practices like these are
prerequisites for making computational research (which increasingly
means \emph{all} research) reproducible.  To facilitate their
adoption, universities and funding agencies need to support the
