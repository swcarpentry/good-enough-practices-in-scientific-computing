...
\item
  ...
  clone GenBank).  \fixme{Arjun Raj says, ``We often store our
    ...
    had to click to get a particular bit of data.''}
...
\item
  ...
  name and/or metadata.  \fixme{Arjun Raj says, ``One question I have
    ...
    can be easier to maintain for small-ish datasets and pipelines.''}
  \fixme{Arjun Raj says, ``This example seems to be more of a data
    tidying situation to me, but perhaps I'm misunderstanding.''}
...
\item
  \recommend{Marshal complementary data in files that meet the same
  ...
  error-prone).  \fixme{Not sure what this point is asking for---the
    term ``marshal'' is new to me in this sense.  Arjun Raj says,
...
\item
  ...
  and the amalgamation of multiple datasets.  \fixme{Arjun Raj says,
    ...
    particulars of the project.  We have done both.''}
...
task-specificity. This makes it easy to re-run \emph{parts} of a data
analysis pipeline, which in turn makes it easier and faster to tinker
with specific data cleaning operations.  \fixme{Arjun Raj says, ``I
