...
The authors are all active contributors to Data Carpentry and/or Software Carpentry.
...
\item
  ...
  columns into a variable of measurements, plus a new variable for time point. Fig~\ref{fig:tidy} presents an example of such a transformation.
