...
\item
  ...
  complete with parameter values}: Data manipulation is as
  much a part of your analysis as any statistics.
  ...
  stage. For example, choosing a region of interest in an image
