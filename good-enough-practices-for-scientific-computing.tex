...
researcher can adopt and should consider adopting.  These recommendations synthesize
...
research computing. As a result, their analyses can take much longer
than necessary, and they may not be able to reproduce their work or
make it reproducible by others. 
...
techniques that we believe every researcher can adopt and should consider adopting. It
...
\item
  ...
  Ensure that raw data is backed up in more than one location. For large data sets, 
  where storage and transfer can be expensive and time-consuming, you may need to 
  use incremental backup or specialized storage systems. 
...
\item
  ...
  projects. For very large data sets, data preparation may also include scripts to obtain 
...
that best balance ease of employment with benefit for you and 
collaborations. 
...
Docs. This solution meets the requirements that we've outlined above, although 
