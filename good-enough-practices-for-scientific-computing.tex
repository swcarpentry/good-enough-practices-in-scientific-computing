...
\caption{Example of gathering columns to create tidy data}
\label{fig:tidy}
\end{figure}
...
\item
  ...
  columns into a variable of measurements, plus a new variable for time point. Figure~\ref{fig:tidy} presents an example of such a transformation.
...
\item
  ...
  Figure~\ref{fig:comment} presents an example of such a comment.
...
combines the technical infrastructure for collaboration via Git and
a modern web interface. GitHub is free for public and open source
projects and for users in academia and nonprofits. A popular hosting
alternative that is itself open source is
\withurl{GitLab}{https://about.gitlab.com}.
