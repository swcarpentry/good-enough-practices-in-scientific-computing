...
It was well received, but many beginners found its
...
\item{Data Management: tidying raw data for sharing and analyses; saving raw and intermediate forms; documenting the data cleaning process}

\item{Software: writing, organizing, and sharing scripts and programs used in an analyses}
...
\item
  ...
  with newcomers. As a rule of thumb, a good size for a single change is
