...
\item
  ...
  minus two)\fixme{GW}{add reference: http://dx.doi.org/10.1037/h0043158} items at once. If we are to understand what our software
...
\item
  ...
  \begin{framed}
    ...
    controlled by an external configuration file.\fixme{GW}{Can this be explained better? I didn't really understand how this works}
  \end{framed}
